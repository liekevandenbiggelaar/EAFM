...
class PriorityQueue:
    ...
    def get_descriptions(self):
        return [descr for descr, quality, idx_sg in self.queue]
    
    def get_qualities(self):
        return [quality for descr, quality, idx_sg in self.queue]
    
    def get_idx(self):
        return [idx_sg for descr, quality, idx_sg in self.queue]
